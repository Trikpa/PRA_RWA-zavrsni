...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
	<div class="form-group row my-4">
		<label for="tbTrenutnaLozinka" class="col-sm-2 col-form-label text-red">Trenutna lozinka</label>
	...
	<div class="form-group row mt-4 mb-3">
		<label for="tbNovaLozinka" class="col-sm-2 col-form-label text-red">Nova lozinka</label>
		<div class="col-sm-8  d-flex align-items-center">
	...
	<div class="form-group row">
		<label for="tbNovaLozinkaPonovno" class="col-sm-2 col-form-label text-red">Nova lozinka ponovno</label>
		<div class="col-sm-8  d-flex align-items-center">
	...
	<div class="form-group row mt-4">
		...
		<div class="col-sm-3">
			<asp:LinkButton ID="btnOdustani" runat="server" CssClass="btn btn-secondary" OnClick="BtnOdustani_Click">Odustani</asp:LinkButton>
		</div>
	</div>
</asp:Content>
